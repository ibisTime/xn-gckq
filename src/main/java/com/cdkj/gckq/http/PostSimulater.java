...
public class PostSimulater {
    ...
    public static String requestPost(String urlString, byte[] requestData,
        ...
        try {
            ...
            con.setRequestMethod(METHOD_POST); // 置为GET方法
            con.setDoInput(true); // �?启输入流
            con.setDoOutput(true); // �?启输出流
            // con.setUseCaches(false); // 不使用缓�?
